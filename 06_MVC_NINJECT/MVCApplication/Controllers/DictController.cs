...
namespace MVCApplication.Controllers
{
    public class DictController : Controller
    {
        ...
        /*        [Inject]
                public IElementsDictionary<Phone> PhoneStorageTest { get; set; }*/

        IElementsDictionary<Record> _phonebook;

        public DictController(IElementsDictionary<Record> phonesDictionary)
        {
            _phonebook = phonesDictionary;
        }
